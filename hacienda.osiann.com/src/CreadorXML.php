    ...
    public function crearXml($datos)
{
    ...
    switch ($tipo) {
        case '01': $ns .= 'facturaElectronica';           $root_element = 'FacturaElectronica';           break;
        case '02': $ns .= 'notaDebitoElectronica';        $root_element = 'NotaDebitoElectronica';        break;
        case '03': $ns .= 'notaCreditoElectronica';       $root_element = 'NotaCreditoElectronica';       break;
        case '04': $ns .= 'tiqueteElectronico';           $root_element = 'TiqueteElectronico';           break;
        case '05': // aceptación
        case '06': // aceptación parcial
        case '07': // rechazo
            $ns .= 'mensajeReceptor';                     $root_element = 'MensajeReceptor';             break;
        case '08': $ns .= 'facturaElectronicaCompra';     $root_element = 'FacturaElectronicaCompra';     break;
        case '09': $ns .= 'facturaElectronicaExportacion';$root_element = 'FacturaElectronicaExportacion';break;
        case '10': $ns .= 'reciboElectronicoPago';        $root_element = 'ReciboElectronicoPago';        break;
        default:   return false;
    }

    // 👇 Quitar "tipo" del payload si viene con "R" para que NO se serialice al XML
    if (isset($datos['tipo']) && strtoupper((string)$datos['tipo']) === 'R') {
        unset($datos['tipo']);
    }
