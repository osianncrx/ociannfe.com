...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2 class="mb-0"><i class="fas fa-plus-circle me-2"></i>Nuevo Plan</h2>
...
<div class="card border-0 shadow-sm">
    <div class="card-body">
        <form method="POST" action="{{ url('/admin/planes') }}">
            @csrf
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <select class="form-select @error('currency') is-invalid @enderror" id="currency" name="currency" required>
                        <option value="CRC" {{ old('currency') == 'CRC' ? 'selected' : '' }}>CRC - Colón</option>
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" class="form-control @error('max_empresas') is-invalid @enderror" id="max_empresas" name="max_empresas" value="{{ old('max_empresas', 1) }}" required>
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" class="form-control @error('max_comprobantes') is-invalid @enderror" id="max_comprobantes" name="max_comprobantes" value="{{ old('max_comprobantes', 100) }}" required>
                    <div class="form-text">Usar -1 para ilimitado</div>
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" class="form-control @error('max_api_keys') is-invalid @enderror" id="max_api_keys" name="max_api_keys" value="{{ old('max_api_keys', 1) }}" required>
                    <div class="form-text">Usar -1 para ilimitado</div>
                    @error('max_api_keys')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                ...
                <div class="col-md-8">
                    ...
                    <div class="d-flex gap-4 mt-2">
                        ...
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" id="s3_storage" name="s3_storage" value="1" {{ old('s3_storage') ? 'checked' : '' }}>
